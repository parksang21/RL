...
class FinalModel:
    def __init__(self, env):
        ...
        self.saver = tf.train.import_meta_graph('weights/50score/100000_episodes.meta')
        self.saver.restore(self.policy.sess, tf.train.latest_checkpoint('weights/50score/'))
