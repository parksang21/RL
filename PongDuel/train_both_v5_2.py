...
class DDQNAgent:  # Double Deep Q-Network
    def __init__(self, model, target_model, env, buffer_size=500, learning_rate=.0015, epsilon=0.1, epsilon_dacay=0.995,
    ...
    def train(self):
        ...
        for t in range(1, self.train_nums):
            ...
            if t % 100 == 0:
                self.model_p.save_weights('./saved_weights2/{}.ckpt'.format(t))
